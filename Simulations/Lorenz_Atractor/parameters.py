...
### Decimation
delta_t_gen =  1e-5 #产生数据集采样时间
delta_t = 0.02 #滤波器实际工作采样时间
...
### Auxiliar MultiDimensional Tensor B and C (they make A --> Differential equation matrix) 辅助多维张量 B 和 C（它们构成 A --> 微分方程矩阵）
...
def toSpherical(cart): #笛卡尔坐标系（Cartesian coordinates）和球坐标系（Spherical coordinates）之间的转换
    """
